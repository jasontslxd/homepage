        ...
        <Navbar.Collapse id="responsive-navbar-nav"> 
          ...
          <Nav>
            ...
            <NavDropdown className="ms-5" title="Theme">
              <NavDropdown.Item onClick={() => onThemeSelection(Theme.LIGHT)}>Light <i className="bi bi-brightness-high-fill" /></NavDropdown.Item>
              <NavDropdown.Item onClick={() => onThemeSelection(Theme.DARK)}>Dark <i className="bi bi-moon-fill" /></NavDropdown.Item>
              <NavDropdown.Item onClick={() => onThemeSelection(Theme.AUTO)}>Auto <i className="bi bi-laptop" /></NavDropdown.Item>
            </NavDropdown>
          </Nav>
        </Navbar.Collapse>
    </Navbar>
