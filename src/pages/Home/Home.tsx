  ...
  return (
    <Container>
      ...
      <Row>
        ...
        <ul className="mx-3 text-align-left">
          ...
          <li>
            ...
            I was a part of the I was part of the <a href="https://www.quantumelectronics.org/home" target="blank">QL2Q Lab</a> (previously Quanics Lab) team,
            working on quantum generative adversarial networks. More information about my research can be found <Link to="/research">here</Link>.
          </li>
          <li>
      ...
      <Row>
        ...
        <p>A list of my publications can be found <Link to="/research">here</Link>, and projects can be found <Link to="/projects">here</Link>.</p>
      </Row>
      ...
      <Row>
        <h2>Hobbies</h2>
        <p>
          My hobbies include football, rock climbing, skiing and playing video games. Here are two photos of me that I thought were pretty cool.
        </p>
        <Row>
